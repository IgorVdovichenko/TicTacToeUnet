...
public class MatchController : MonoBehaviour 
{
	...
	[HideInInspector] public PlayerController remotePlayer;
	[HideInInspector] public PlayerController hostPlayer;
	[HideInInspector] public PlayerController clientPlayer;
